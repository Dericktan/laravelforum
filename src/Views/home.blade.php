...
@section(Config::get('chatter.yields.head'))
    <link href="/vendor/dericktan/chatter/assets/vendor/spectrum/spectrum.css" rel="stylesheet">
	    	...
	    	<div class="col-md-3 left-column">
	    		...
	    		<div class="chatter_sidebar">
					...
					<ul class="nav nav-pills nav-stacked">
						<?php $categories = DerickTan\Chatter\Models\Models::category()->all(); ?>
				        		...
				        		<a class="discussion_list" href="/{{ Config::get('chatter.routes.home') }}/{{ Config::get('chatter.routes.discussion') }}/{{ $discussion->category->slug }}/{{ $discussion->slug }}">
					        		<div class="chatter_avatar">
					        			...
					        			@else
					        				...
					        				<span class="chatter_avatar_circle" style="background-color:#<?= \DerickTan\Chatter\Helpers\ChatterHelper::stringToColorCode($discussion->user->email) ?>">
...
<script src="/vendor/dericktan/chatter/assets/vendor/spectrum/spectrum.js"></script>
