    ...
    public function run()
    {
        ...
        <p>You\'ll probably want to delete this user, but if for some reason you want to keep it... Go ahead :)</p>',
                ...
                2 => [
                    ...
                    'user_id'               => 1,
                    'body'                  => '<p>If you would like to leave some feedback or have any issues be sure to visit the github page here: <a href="https://github.com/thedericktan/chatter" target="_blank">https://github.com/thedericktan/chatter</a>&nbsp;and I\'m sure I can help out.</p>
        ...
        5 => [
            ...
            'user_id'               => 1,
            'body'                  => '<p>Hey There!</p>
        <p>My name is Tony and I\'m the creator of this package that you\'ve just installed. Thanks for checking out it out and if you have any questions or want to contribute be sure to checkout the repo here: <a href="https://github.com/thedericktan/chatter" target="_blank">https://github.com/thedericktan/chatter</a></p>
